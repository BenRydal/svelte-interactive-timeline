 ...
 */
export function formatTime(seconds, format = 'hms') {
 ...
 */
export function calculateGridInterval(visibleDuration, maxLabels = 10) {
 ...
 */
export function generateGridLines(viewStart, viewEnd, maxLabels = 10) {
 ...
 */
export function zoomAtPoint(currentViewStart, currentViewEnd, zoomFactor, centerTime, dataStart, dataEnd, minDuration) {
 ...
 */
export function panView(currentViewStart, currentViewEnd, deltaTime, dataStart, dataEnd) {
